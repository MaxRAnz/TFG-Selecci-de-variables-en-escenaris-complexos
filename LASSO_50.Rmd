...
system.time({
  for (i in 1:nrow(comb)) {
    ...
    for (j in 1:iters) {
      ...
      lambda_estim <- cv.glmnet(X_mat, y_vec, family = "binomial", alpha = 1,maxit = 1000000, thresh = 1e-7)
      model_lasso  <- glmnet(X_mat, y_vec, alpha = 1, family = "binomial",
                             lambda = lambda_estim$lambda.min,maxit = 1000000, thresh = 1e-7)
